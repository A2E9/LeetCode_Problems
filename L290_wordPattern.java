...
public class L290_wordPattern {
    ...
    public static boolean wordPattern(String pattern, String s) {
        ...
        // System.out.println("\npatternArr[fr]: " + patternArr[fr] + " : index fr: " +
        // fr);
        // System.out.println("patternArr[sc]: " + patternArr[sc] + " : index sc : " +
        // sc);
        // countPattern++;
        ...
        for (int i = 0; i < strArr.length; i++)
            if (!(Arrays.asList(strArr).indexOf(strArr[i]) == Arrays.asList(patternArr).indexOf(patternArr[i])))
                return false;
